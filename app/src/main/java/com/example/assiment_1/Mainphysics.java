...
public class Mainphysics extends AppCompatActivity {
    ...
    private void saveText(String text) {
        ...
        editor.putString("digitalText", text);  // Unique key for digital page
        editor.apply();
    }

    private void loadText() {
        // Loading text using a unique key for digital page
        String storedText = sharedPreferences.getString("digitalText", "");
